...
namespace Squabble.Controllers.API
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegistrationRequest model)
        {
            ...
            var (user, accessToken) = await _commTokenManager.CreateUserAndTokenAsync();
            ...
            var account = new User
            {
                ...
                CommunicationToken = accessToken.Token
            };
        ...
        public async Task<IActionResult> GetSecurityQuestions(string username)
        {
            ...
            if (login.Account.IsSso)
            {
                return BadRequest("Accounts using SSO can't reset non-existent password.");
            }
